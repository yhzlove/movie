	...
	<div class="right">
		...
		<div class="top">
			...
			<div class="position pullleft ">
				<p>
					<span class="STYLE1">场次安排管理--修改</span>
				</p>
			</div>
		...
		<div class="right-ctn">
			<div class="bordernormal plr20">
				<form action="<%=request.getContextPath()%>/showFilm/back/update/${showFilm.id }" method="post" >
					<label class="labelnormal">基本信息</label>
					<div class="height20"></div>
					<input type="hidden" name="id" value="${showFilm.id }">
					<input type="hidden" name="movie.id" value="${showFilm.movie.id }">
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." 
									 style=" padding:0 12px;" readonly="readonly" value="${showFilm.movie.movieName}">
							</div>
						</div>
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								<label class="font14 widthtextalignr">
									...
									<select name="hall.id" class="form-control widthlonger bglightgrey">
								   			<option value="${showFilm.hall.id}" selected>${showFilm.hall.name}</option>
								   	</select>
							</div>
						</div>
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="startTime"
									name="startTime" style=" padding:0 12px;" readonly="readonly" onchange="endDate(this);" value="<fmt:formatDate value="${showFilm.startTime}" pattern="yyyy-MM-dd HH:mm" />"
...
<!-- 										onpicked:pickedFunc()  -->
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="自动生成" id="endTime" value="<fmt:formatDate value="${showFilm.endTime}" pattern="yyyy-MM-dd HH:mm" />"
					...
					<div class=" overflowhidden">
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="showFilmName" value="${showFilm.showFilmName }"
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="price" value="${showFilm.price }"
							...
							<div class="formgroup">
								<label class="font14 widthtextalignr ">
									...
									<select class="form-control widthlonger " name="flag" id="flag"
										...
										<option value="1" <c:if test="${showFilm.flag=='1'}">selected</c:if>>启用</option>
										<option value="2" <c:if test="${showFilm.flag=='2'}">selected</c:if>>暂停使用</option>
									</select>
							</div>
						</div>
					...
					<div class="formgroup">
						...
						<textarea rows="3" name="remark" id="remark"
							class="form-control textareawidthlong bglightgrey">${showFilm.remark }</textarea>
					</div>
...
function endDate(_this){
	var star = $(_this).val();
	var length = "${showFilm.movie.length}";//1分钟
	var t = new Date(star);
