	...
	<div class="right">
		...
		<div class="top">
			...
			<div class="position pullleft ">
				<p>
					<span style="font-size: 18px;">影厅管理--添加</span>
				</p>
			</div>
		...
		<div class="right-ctn">
			<div class="bordernormal plr20">
				<form action="<%=request.getContextPath()%>/hall/back/add" method="post"
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="name"
									name="name" style=" padding:0 12px;">
							</div>
						</div>
						<!---两列 end-->
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="自动生成" id="seatCount"
									name="seatCount" style=" padding:0 12px;" readonly="readonly">
							</div>
						</div>
					...
					<div class="formgroup">
						...
						<input class="form-control widthlonger" style="width:40%; padding-right:2%;" placeholder="请在此处输入..." id="addr"
									name="addr" style=" padding:0 12px;">
					</div>
					...
					<div class=" overflowhidden" id="seatDiv" style="display: none;">
						...
						<div class="demo">
							...
							<div class="booking-details">
								<p>排：<span id="rows"></span></p>
								<p>位：<span id="cols"></span></p>
								<p>座位数：<span id="counts"></span></p>
								<p>删除座位：</p>
