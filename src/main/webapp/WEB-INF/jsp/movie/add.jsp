	...
	<div class="right">
		...
		<div class="top">
			...
			<div class="position pullleft ">
				<p>
					<span class="STYLE1">电影管理--添加</span>
				</p>
			</div>
		...
		<div class="right-ctn">
			<div class="bordernormal plr20">
				<form action="<%=request.getContextPath()%>/movie/back/add" method="post"
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="movieName"
									name="movieName" style=" padding:0 12px;">
							</div>
						</div>
						<!---两列 end-->
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="shortName"
									name="shortName" style=" padding:0 12px;">
							</div>
						</div>
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="director"
									name="director" style=" padding:0 12px;">
							</div>
						</div>
						<!---两列 end-->
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="actor"
									name="actor" style=" padding:0 12px;">
							</div>
						</div>
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="category"
									name="category" style=" padding:0 12px;">
							</div>
						</div>
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								class="input_text Wdate" onClick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',minDate:'%y-%M-{%d+1}'})"
									name="showTime" style=" padding:0 12px;" readonly="readonly">
							</div>
						</div>
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="starRating"
									name="starRating" style=" padding:0 12px;">
							</div>
						</div>
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="length"
									name="length" style=" padding:0 12px;" >
							</div>
						</div>
					</div>
					<div class="formgroup">
					...
					<div class=" overflowhidden">
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input type="hidden" id="pmt" name="imgUrl" /> 
					...
					<div class=" overflowhidden">
						...
						<div class="pullleft" style="width:96%; padding-right:2%;">
							...
							<div class="formgroup" id="videoDiv">
								...
								<input type="hidden" id="video" name="videoUrl" /> 
								<a href="javascript:;" class="file">选择文件 
