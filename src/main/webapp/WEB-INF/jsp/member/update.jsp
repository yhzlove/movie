...
// 			var Fields = "memberName;name;password_M;role.id";
	...
	<div class="right">
        ...
        <div class="right-ctn">
			<div class="bordernormal plr20">
				<form action="<%=request.getContextPath()%>/member/back/update/${member.id}" method="post"
					...
					<div class=" overflowhidden">
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="memberName"
									name="memberName" style=" padding:0 12px;" value="${member.userName}">
							</div>
						</div>
						<!---两列 end-->
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="password"
									name="password" style=" padding:0 12px;" value="${member.password}">
							</div>
						</div>
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="realName"
									name="realName" style=" padding:0 12px;" value="${member.realName}">
							</div>
						</div>
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger" placeholder="请在此处输入..." id="email"
									name="email" style=" padding:0 12px;" value="${member.email}">
							</div>
						</div>
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="tel"
									name="tel" style=" padding:0 12px;" value="${member.tel}">
							</div>
						</div>
<!-- 						<div class="pullleft" style="width:48%; padding-right:2%;"> -->
<!-- 							<div class="formgroup"> -->
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							<div class="formgroup">
								...
								<select class="form-control widthlonger " name="roleid" id="roleid"
									...
									<option value="1" <c:if test="${member.roleid=='1'}">selected</c:if>>会员</option>
								</select>
							</div>
						</div>
							...
							<div class="formgroup">
								<label class="font14 widthtextalignr ">
									...
									<select class="form-control widthlonger " name="flag" id="flag"
										style=" padding:0 12px;width: 196px;">
										<option value="1" <c:if test="${member.flag=='1'}">selected</c:if>>可登入</option>
										<option value="2" <c:if test="${member.flag=='2'}">selected</c:if>>不可登入</option>
									</select>
							</div>
						</div>
					</div>
