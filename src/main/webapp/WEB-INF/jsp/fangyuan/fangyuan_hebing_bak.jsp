...
<body>
	...
	<div class="right-ctn">
		<form action="<%=request.getContextPath()%>/fangy/hebing" method="post">
			<div class="formgroup">
				<!---formgroup start-->
...
<!-- 					<c:out value="${id}" /> -->
				...
				<div class="overflowhidden">
					...
					<input type='text' name="lz" value='${fangy1.lz}' />
				</div>
				<label class="labelnormal">房间号</label>
				<div class="overflowhidden">

					<input type='text' name="fjh" value='${fangy1.fjh}' />
				</div>
				<label class="labelnormal">建筑面积</label>
				<div class="overflowhidden">

					<input type='text' name="mj" value='${fangy1.mj}' />
				</div>
				...
				<div class="overflowhidden">
					<div class="radio pullleft">
						<label> <input type="radio" name="hx"
							id="optionsRadios1" value="1" <c:if test="${fangy1.hx=='1'}">checked</c:if>>内环 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="hx"
							id="optionsRadios2" value="2" <c:if test="${fangy1.hx=='2'}">checked</c:if>>外环 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="hx"
							id="optionsRadios3" value="3" <c:if test="${fangy1.hx=='3'}">checked</c:if>>阳面 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="hx"
							id="optionsRadios4" value="4" <c:if test="${fangy1.hx=='4'}">checked</c:if>>阴面 </label>
					</div>
				</div>
			</div>
			<div class="formgroup">
				...
				<div class="overflowhidden">
					<div class="radio">
						<label> <input type="radio" name="sb"
							id="optionsRadios1" value="1" <c:if test="${fangy1.sb=='1'}">checked</c:if>>有中央空调 </label>
					</div>
					<div class="radio">
						<label> <input type="radio" name="sb"
							id="optionsRadios2" value="2" <c:if test="${fangy1.sb=='2'}">checked</c:if>>无中央空调 </label>
					</div>
				...
				<div class="overflowhidden">
					<div class="radio pullleft">
						<label> <input type="radio" name="zx"
							id="optionsRadios1" value="1" <c:if test="${fangy1.zx=='1'}">checked</c:if>>装修 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="zx"
							id="optionsRadios2" value="2" <c:if test="${fangy1.zx=='2'}">checked</c:if>>未装修 </label>
					</div>
				...
				<div class="overflowhidden">
					<div class="radio pullleft">
						<label> <input type="radio" name="fwzt"
							id="optionsRadios1" value="1" <c:if test="${fangy1.fwzt=='1'}">checked</c:if>>空置 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="fwzt"
							id="optionsRadios2" value="2" <c:if test="${fangy1.fwzt=='2'}">checked</c:if>>定置 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="fwzt"
							id="optionsRadios3" value="3" <c:if test="${fangy1.fwzt=='3'}">checked</c:if>>预留 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="fwzt"
							id="optionsRadios4" value="4" <c:if test="${fangy1.fwzt=='4'}">checked</c:if>>预退 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="fwzt"
							id="optionsRadios5" value="5" <c:if test="${fangy1.fwzt=='5'}">checked</c:if>>入住 </label>
					</div>
					<div class="radio pullleft">
						<label> <input type="radio" name="fwzt"
							id="optionsRadios6" value="6" <c:if test="${fangy1.fwzt=='6'}">checked</c:if>>停用 </label>
					</div>
				</div>
			</div>
			<!---formgroup end-->
			...
			<label class="labelnormal">平面图</label><br /> 
			...
			<br /> <label class="labelnormal"> 房屋装修图</label><br /> 
			...
			<br /> 
			<label class="labelnormal"> 实物图1</label> <br /> 
