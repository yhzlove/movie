	...
	<div class="right">
		...
		<div class="top">
			...
			<div class="position pullleft ">
				<p>
					<span class="STYLE1">留言管理--添加</span>
				</p>
			</div>
		...
		<div class="right-ctn">
			<div class="bordernormal plr20">
				<form action="<%=request.getContextPath()%>/comment/add" method="post"
						...
						<div class="pullleft" style="width:48%; padding-right:2%;">
							...
							<div class="formgroup">
								<label class="font14 widthtextalignr ">
									<span class="required">*</span>分数：</label> 
								<input class="form-control widthlonger validator" placeholder="请在此处输入..." id="score"
									name="score" style=" padding:0 12px;">
							</div>
						</div>
					...
					<div class="formgroup">
						<label class="font14 widthtextalignr">内容：</label>
